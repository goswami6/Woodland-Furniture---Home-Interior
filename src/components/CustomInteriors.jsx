      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-8">
          <p className="text-[#4c4c4c] text-[14px] sm:text-[15px] lg:text-[16px] leading-[1.8]">
            Since 2014, we have been transforming the essence of home interiors across Pune — from Kothrud, Baner, and Hinjewadi to Wakad, Aundh, Kharadi, and beyond. Our expertise goes beyond aesthetics to include thoughtful designs that reflect style and functionality. Our dedicated team of interior designers understands the need for space and functionality, and offers customers exactly what they need. We provide complete furnishing for beautiful home interiors including modular kitchen furnishing, living and dining, bedroom interiors, pooja room design, and office interiors to help bring your dream to life. If you would like to find out more about the interior solutions we offer then just contact us, and our designers will be in touch.
          </p>
        </div>
