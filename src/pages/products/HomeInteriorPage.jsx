...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1600210491369-e753d80a41f3?w=800&q=80', alt: 'Modern living room interior' },
  { src: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&q=80', alt: 'Premium bedroom design' },
  { src: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80', alt: 'Luxury home interior' },
  { src: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=800&q=80', alt: 'Contemporary living space' },
  { src: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80', alt: 'Designer kitchen and living' },
  { src: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=80', alt: 'Elegant home decor' },
];

const interiorTypes = [
  { name: 'LIVING ROOM', img: 'https://images.unsplash.com/photo-1600210491369-e753d80a41f3?w=600&q=80' },
  { name: 'BEDROOM', img: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80' },
  { name: 'KITCHEN', img: 'https://images.unsplash.com/photo-1622372738946-62e02505feb3?w=600&q=80' },
  { name: 'DINING AREA', img: 'https://images.unsplash.com/photo-1617104678098-de229db51175?w=600&q=80' },
  { name: 'POOJA ROOM', img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80' },
];

const features = [
  { icon: '🏠', title: 'End-to-End Solutions', desc: 'From concept design to final handover — we handle every aspect of your home interior transformation.' },
  { icon: '🎨', title: '3D Visualization', desc: 'See your dream home in realistic 3D renders before we begin, ensuring complete satisfaction.' },
  { icon: '🪵', title: 'Premium Materials', desc: 'Teak-wood, commercial plywood, and imported laminates for durability and a luxurious finish.' },
  { icon: '📐', title: 'Space Optimization', desc: 'Smart layouts that maximize functionality and storage without compromising on aesthetics.' },
  { icon: '🛡️', title: '10-Year Warranty', desc: 'Complete peace of mind with our comprehensive warranty on all interior work.' },
  { icon: '🔧', title: 'Professional Installation', desc: 'Expert installation team ensures flawless execution with minimal disruption to your daily life.' },
];

const stats = [
  { title: '800+', sub: 'Homes Delivered' },
  { title: 'SINCE', sub: '2014' },
  { title: '100%', sub: 'Customized' },
  { title: '3D', sub: 'Design Preview' },
];

const HomeInteriorPage = () => {
  ...
  return (
    <div ref={pageRef}>
      <PageBanner
        desktopImage="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1920&q=80"
        mobileImage="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80"
        overlayText="HOME INTERIOR"
      />
        ...
        <div className="w-full max-w-full px-5 min-[468px]:px-8 sm:px-10 md:px-[80px] lg:px-[100px] mx-auto xl:px-0">
          <div className="flex flex-wrap">
            <div className="w-full xl:w-1/2 max-[468px]:hidden" style={fadeStyle('intro', 0)}>
              <img
                src="https://images.unsplash.com/photo-1600210491369-e753d80a41f3?w=900&q=80"
                alt="Home Interior"
            ...
            >
              <div className="w-full">
                <h2 className="font-['Mulish',sans-serif] font-normal uppercase text-black text-[22px] leading-[30px] min-[468px]:text-[28px] min-[468px]:leading-normal sm:text-[30px] xl:text-[28px] min-[1700px]:text-[32px] m-0 p-0 mb-4">
                  HOME <span className="text-[#814882] font-semibold">INTERIOR</span>
                </h2>
                <p className="m-0 text-[#4c4c4c] text-[15px] leading-[25px] sm:text-base sm:leading-[26px] mb-8">
                  Transform your home into a stunning living space with Woodland Furniture's complete home interior solutions. From modular kitchens and wardrobes to living room setups, bedroom designs, and pooja rooms — we deliver fully customized interiors crafted with Teak-wood, premium plywood, and imported fittings. Every project starts with a detailed 3D walkthrough so you see your dream home before we build it.
                </p>
      ...
      <section className="py-[25px] sm:py-[45px] bg-white overflow-hidden" data-anim="types">
        ...
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto">
          <div className="flex flex-wrap gap-[3px] sm:gap-[6px]">
            {interiorTypes.map((type, idx) => (
              <div key={idx} className={idx === 0 ? 'w-full' : 'w-[calc(50%-3px)] sm:w-[calc(50%-6px)]'} style={fadeStyle('types', idx * 0.15)}>
      ...
      <section className="py-[35px] sm:py-[50px] lg:py-[60px] bg-[#f8f8f8] overflow-hidden" data-anim="cta">
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto text-center" style={fadeStyle('cta')}>
          <h2 className="font-normal uppercase text-black text-[22px] min-[468px]:text-[28px] sm:text-[30px] lg:text-[34px] min-[1390px]:text-[38px] mb-4" style={{ fontFamily: "'Mulish', sans-serif" }}>
            READY TO TRANSFORM YOUR <span className="text-[#814882] font-semibold">HOME?</span>
          </h2>
          <p className="text-[#4c4c4c] text-[14px] sm:text-[15px] leading-[1.8] max-w-[600px] mx-auto mb-8">
            Book a free consultation with our design team. We'll visit your home, understand your lifestyle, and present a stunning 3D design.
          </p>
          <button onClick={() => setShowModal(true)} className="btn-comn hoveranim">
...
export default HomeInteriorPage;
