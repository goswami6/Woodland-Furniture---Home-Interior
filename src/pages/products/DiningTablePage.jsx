...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1617104678098-de229db51175?w=800&q=80', alt: '4-Seater dining table' },
  { src: 'https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?w=800&q=80', alt: '6-Seater dining set' },
  { src: 'https://images.unsplash.com/photo-1595428774223-ef52624120d2?w=800&q=80', alt: '8-Seater dining table' },
  { src: 'https://images.unsplash.com/photo-1549497538-303791108f95?w=800&q=80', alt: 'Extendable dining table' },
  { src: 'https://images.unsplash.com/photo-1594026112284-02bb6f3352fe?w=800&q=80', alt: 'Modern dining room' },
  { src: 'https://images.unsplash.com/photo-1600585152915-d208bec867a1?w=800&q=80', alt: 'Solid wood dining set' },
];

const tableTypes = [
  { name: '4-SEATER', img: 'https://images.unsplash.com/photo-1617104678098-de229db51175?w=600&q=80' },
  { name: '6-SEATER', img: 'https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?w=600&q=80' },
  { name: '8-SEATER', img: 'https://images.unsplash.com/photo-1595428774223-ef52624120d2?w=600&q=80' },
  { name: 'EXTENDABLE', img: 'https://images.unsplash.com/photo-1549497538-303791108f95?w=600&q=80' },
];

const features = [
  { icon: '🪵', title: 'Solid Teak-wood', desc: 'Table top and legs crafted from genuine Sagwan wood for lasting strength.' },
  { icon: '📐', title: 'Custom Sizes', desc: '4, 6, 8-seater or any custom size — we build to your dining room dimensions.' },
  { icon: '🎨', title: '20+ Finishes', desc: 'Natural teak, walnut, rosewood, white-wash, and more polish options.' },
  { icon: '🪑', title: 'Matching Chairs', desc: 'Cushioned, ladder-back, or bench-style seating in matching wood and finish.' },
  { icon: '🛡️', title: 'Scratch Resistant', desc: 'PU-coated surface protects against scratches, stains, and heat marks.' },
  { icon: '🔄', title: 'Extendable Option', desc: 'Butterfly-leaf extension mechanism for flexible seating capacity.' },
];

const stats = [
  { title: '400+', sub: 'Tables Made' },
  { title: 'SINCE', sub: '2014' },
  { title: '100%', sub: 'Solid Wood' },
  { title: '20+', sub: 'Finishes' },
];
...
const DiningTablePage = () => {
  ...
  return (
    <div ref={pageRef}>
      <PageBanner desktopImage="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1920&q=80" mobileImage="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80" overlayText="DINING" />
        ...
        <div className="w-full max-w-full px-5 min-[468px]:px-8 sm:px-10 md:px-[80px] lg:px-[100px] mx-auto xl:px-0">
          <div className="flex flex-wrap">
            <div className="w-full xl:w-1/2 max-[468px]:hidden" style={fadeStyle('intro', 0)}>
              <img src="https://images.unsplash.com/photo-1617104678098-de229db51175?w=900&q=80" alt="Dining Table" className="w-full h-full object-cover max-h-[260px] lg:max-h-[450px] xl:max-h-none" loading="lazy" />
            </div>
            <div className="w-full xl:w-1/2 flex items-center content-center flex-wrap py-10 sm:py-[45px] xl:py-[25px] px-5 min-[468px]:px-8 sm:px-10 md:px-[40px] lg:px-[50px] xl:px-[30px] justify-center" style={fadeStyle('intro', 0.15)}>
              <div className="w-full">
                <h2 className="font-['Mulish',sans-serif] font-normal uppercase text-black text-[22px] leading-[30px] min-[468px]:text-[28px] min-[468px]:leading-normal sm:text-[30px] xl:text-[28px] min-[1700px]:text-[32px] m-0 p-0 mb-4">
                  DINING <span className="text-[#814882] font-semibold">TABLE</span>
                </h2>
                <p className="m-0 text-[#4c4c4c] text-[15px] leading-[25px] sm:text-base sm:leading-[26px] mb-8">
                  Our dining tables are handcrafted from solid Teak-wood (Sagwan) with matching chairs designed for comfort and durability. Available in 4, 6, 8-seater, and custom extendable configurations. Choose from 20+ finish options to complement your dining room aesthetic.
                </p>
      ...
      <section className="py-[25px] sm:py-[45px] bg-white overflow-hidden" data-anim="types">
        <div className="section-head mb-[25px] sm:mb-[35px]"><h2>TABLE SIZES</h2></div>
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto">
      ...
      <section className="py-[35px] sm:py-[50px] lg:py-[60px] bg-[#f8f8f8] overflow-hidden" data-anim="cta">
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto text-center" style={fadeStyle('cta')}>
          <h2 className="font-normal uppercase text-black text-[22px] min-[468px]:text-[28px] sm:text-[30px] lg:text-[34px] min-[1390px]:text-[38px] mb-4" style={{ fontFamily: "'Mulish', sans-serif" }}>
            GATHER AROUND A <span className="text-[#814882] font-semibold">BEAUTIFUL TABLE</span>
          </h2>
          <p className="text-[#4c4c4c] text-[14px] sm:text-[15px] leading-[1.8] max-w-[600px] mx-auto mb-8">Tell us your dining room size and seating needs — we'll craft the perfect table and chairs for your family.</p>
