...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80', alt: 'Wall-mounted mandir' },
  { src: 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=800&q=80', alt: 'Floor-standing mandir' },
  { src: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800&q=80', alt: 'Modular pooja unit' },
  { src: 'https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=800&q=80', alt: 'LED backlit mandir' },
  { src: 'https://images.unsplash.com/photo-1600210492493-0946911123ea?w=800&q=80', alt: 'Traditional CNC design' },
  { src: 'https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?w=800&q=80', alt: 'Custom pooja room' },
];

const mandirTypes = [
  { name: 'WALL-MOUNTED', img: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80' },
  { name: 'FLOOR-STANDING', img: 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=600&q=80' },
  { name: 'MODULAR', img: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=600&q=80' },
  { name: 'POOJA ROOM', img: 'https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=600&q=80' },
];

const features = [
  { icon: '🪵', title: 'Solid Teak-wood', desc: 'Built from genuine Sagwan wood with traditional joinery for lasting strength.' },
  { icon: '✨', title: 'LED Backlighting', desc: 'Warm LED strips and spotlights that highlight the deity area beautifully.' },
  { icon: '🎭', title: 'CNC Carved Panels', desc: 'Intricate traditional patterns — jaali, floral, peacock, temple — precision-cut on CNC.' },
  { icon: '📐', title: 'Custom Dimensions', desc: 'Designed to fit your wall space, niche, or dedicated pooja room perfectly.' },
  { icon: '🔔', title: 'Accessory Storage', desc: 'Dedicated drawers and shelves for pooja essentials, diyas, and incense.' },
  { icon: '🛡️', title: 'Quality Finish', desc: 'Premium polish with brass or gold-finish accents for a divine look.' },
];

const stats = [
  { title: '300+', sub: 'Mandirs Made' },
  { title: 'SINCE', sub: '2014' },
  { title: 'LED', sub: 'Backlit' },
  { title: 'CNC', sub: 'Carved' },
];

const ModularMandirPage = () => {
  ...
  return (
    <div ref={pageRef}>
      <PageBanner desktopImage="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1920&q=80" mobileImage="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80" overlayText="MANDIR" />
        ...
        <div className="w-full max-w-full px-5 min-[468px]:px-8 sm:px-10 md:px-[80px] lg:px-[100px] mx-auto xl:px-0">
          <div className="flex flex-wrap xl:flex-row-reverse">
            <div className="w-full xl:w-1/2 max-[468px]:hidden" style={fadeStyle('intro', 0)}>
              <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=900&q=80" alt="Modular Mandir" className="w-full h-full object-cover max-h-[260px] lg:max-h-[450px] xl:max-h-none" loading="lazy" />
            </div>
            <div className="w-full xl:w-1/2 flex items-center content-center flex-wrap py-10 sm:py-[45px] xl:py-[25px] px-5 min-[468px]:px-8 sm:px-10 md:px-[40px] lg:px-[50px] xl:px-[30px] justify-center" style={fadeStyle('intro', 0.15)}>
              <div className="w-full">
                <h2 className="font-['Mulish',sans-serif] font-normal uppercase text-black text-[22px] leading-[30px] min-[468px]:text-[28px] min-[468px]:leading-normal sm:text-[30px] xl:text-[28px] min-[1700px]:text-[32px] m-0 p-0 mb-4">
                  MODULAR <span className="text-[#814882] font-semibold">MANDIR</span>
                </h2>
                <p className="m-0 text-[#4c4c4c] text-[15px] leading-[25px] sm:text-base sm:leading-[26px] mb-8">
                  Create a sacred space at home with our custom-built wooden mandirs. Wall-mounted, floor-standing, or dedicated pooja rooms — each mandir is crafted from solid Teak-wood with CNC-carved traditional panels, LED backlighting, and storage for pooja essentials. Designed to bring devotion and elegance to your home.
                </p>
      ...
      <section className="py-[25px] sm:py-[45px] bg-white overflow-hidden" data-anim="types">
        <div className="section-head mb-[25px] sm:mb-[35px]"><h2>MANDIR STYLES</h2></div>
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto">
          <div className="flex flex-wrap gap-[3px] sm:gap-[6px]">
            {mandirTypes.map((type, idx) => (
      ...
      <section className="py-[35px] sm:py-[50px] lg:py-[60px] bg-[#f8f8f8] overflow-hidden" data-anim="cta">
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto text-center" style={fadeStyle('cta')}>
          <h2 className="font-normal uppercase text-black text-[22px] min-[468px]:text-[28px] sm:text-[30px] lg:text-[34px] min-[1390px]:text-[38px] mb-4" style={{ fontFamily: "'Mulish', sans-serif" }}>
            CREATE A <span className="text-[#814882] font-semibold">SACRED SPACE</span> AT HOME
          </h2>
          <p className="text-[#4c4c4c] text-[14px] sm:text-[15px] leading-[1.8] max-w-[600px] mx-auto mb-8">Share your wall space and design preferences — we'll craft a mandir that brings divinity and beauty to your home.</p>
...
export default ModularMandirPage;
