...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800&q=80', alt: 'King size wooden bed' },
  { src: 'https://images.unsplash.com/photo-1617325247661-675ab4b64ae2?w=800&q=80', alt: 'Queen size bed design' },
  { src: 'https://images.unsplash.com/photo-1588046130717-0eb0c9a3ba15?w=800&q=80', alt: 'Storage bed' },
  { src: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&q=80', alt: 'Bedroom interior' },
  { src: 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=800&q=80', alt: 'Poster bed design' },
  { src: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=800&q=80', alt: 'Modern wooden bed' },
];

const bedTypes = [
  { name: 'KING SIZE', img: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=600&q=80' },
  { name: 'QUEEN SIZE', img: 'https://images.unsplash.com/photo-1617325247661-675ab4b64ae2?w=600&q=80' },
  { name: 'STORAGE BED', img: 'https://images.unsplash.com/photo-1588046130717-0eb0c9a3ba15?w=600&q=80' },
  { name: 'POSTER BED', img: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80' },
];

const features = [
  { icon: '🪵', title: 'Solid Teak-wood', desc: 'Built from genuine Sagwan wood, known for strength and natural termite resistance.' },
  { icon: '📐', title: 'Custom Sizes', desc: 'King, Queen, Single — or any custom dimension to fit your bedroom perfectly.' },
  { icon: '📦', title: 'Hydraulic Storage', desc: 'Lift-up and drawer storage options to maximise your bedroom space.' },
  { icon: '🎨', title: 'Finish Options', desc: 'Natural teak, walnut, dark mahogany, white-wash — choose your preferred look.' },
  { icon: '🛡️', title: '5 Year Warranty', desc: 'Comprehensive warranty covering structural defects and hardware issues.' },
  { icon: '🛏️', title: 'Matching Furniture', desc: 'Side tables, dressing tables, and wardrobes in matching design and finish.' },
];

const stats = [
  { title: '600+', sub: 'Beds Made' },
  { title: 'SINCE', sub: '2014' },
  { title: '100%', sub: 'Solid Wood' },
  { title: '5 YR', sub: 'Warranty' },
];
...
const WoodenBedPage = () => {
  ...
  return (
    <div ref={pageRef}>
      <PageBanner desktopImage="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1920&q=80" mobileImage="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80" overlayText="BED" />
        ...
        <div className="w-full max-w-full px-5 min-[468px]:px-8 sm:px-10 md:px-[80px] lg:px-[100px] mx-auto xl:px-0">
          <div className="flex flex-wrap">
            <div className="w-full xl:w-1/2 max-[468px]:hidden" style={fadeStyle('intro', 0)}>
              <img src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=900&q=80" alt="Wooden Bed" className="w-full h-full object-cover max-h-[260px] lg:max-h-[450px] xl:max-h-none" loading="lazy" />
            </div>
            <div className="w-full xl:w-1/2 flex items-center content-center flex-wrap py-10 sm:py-[45px] xl:py-[25px] px-5 min-[468px]:px-8 sm:px-10 md:px-[40px] lg:px-[50px] xl:px-[30px] justify-center" style={fadeStyle('intro', 0.15)}>
              <div className="w-full">
                <h2 className="font-['Mulish',sans-serif] font-normal uppercase text-black text-[22px] leading-[30px] min-[468px]:text-[28px] min-[468px]:leading-normal sm:text-[30px] xl:text-[28px] min-[1700px]:text-[32px] m-0 p-0 mb-4">
                  WOODEN <span className="text-[#814882] font-semibold">BED</span>
                </h2>
                <p className="m-0 text-[#4c4c4c] text-[15px] leading-[25px] sm:text-base sm:leading-[26px] mb-8">
                  Our wooden beds are crafted from solid Teak-wood (Sagwan) with precision joinery for a sturdy, long-lasting frame. Available in King, Queen, and custom sizes with optional hydraulic storage. Choose from multiple finish options and matching bedroom furniture to complete your space.
                </p>
      ...
      <section className="py-[25px] sm:py-[45px] bg-white overflow-hidden" data-anim="types">
        <div className="section-head mb-[25px] sm:mb-[35px]"><h2>BED STYLES</h2></div>
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto">
            ...
            {bedTypes.map((type, idx) => (
              <div key={idx} className="w-[calc(50%-3px)] sm:w-[calc(50%-6px)]" style={fadeStyle('types', idx * 0.15)}>
                <Link to="/contact" className="block h-[155px] sm:h-[280px] md:h-[320px] min-[1681px]:h-[380px] relative overflow-hidden group bg-white">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-black text-white uppercase transition-colors duration-500 group-hover:text-[#814882] z-[1] text-[22px] min-[390px]:text-[26px] min-[468px]:text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px]" style={{ fontFamily: "'Mulish', sans-serif" }}>{type.name}</div>
                </Link>
              </div>
            ))}
          </div>
      ...
      <section className="py-[35px] sm:py-[50px] lg:py-[60px] bg-[#f8f8f8] overflow-hidden" data-anim="cta">
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto text-center" style={fadeStyle('cta')}>
          <h2 className="font-normal uppercase text-black text-[22px] min-[468px]:text-[28px] sm:text-[30px] lg:text-[34px] min-[1390px]:text-[38px] mb-4" style={{ fontFamily: "'Mulish', sans-serif" }}>
            SLEEP BETTER ON <span className="text-[#814882] font-semibold">SOLID WOOD</span>
          </h2>
          <p className="text-[#4c4c4c] text-[14px] sm:text-[15px] leading-[1.8] max-w-[600px] mx-auto mb-8">Share your bedroom dimensions — we'll design a bed that fits perfectly and lasts for decades.</p>
