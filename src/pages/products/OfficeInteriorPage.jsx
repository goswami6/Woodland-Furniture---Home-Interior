...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80', alt: 'Modern office space' },
  { src: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=800&q=80', alt: 'Executive cabin interior' },
  { src: 'https://images.unsplash.com/photo-1497215842964-222b430dc094?w=800&q=80', alt: 'Open office design' },
  { src: 'https://images.unsplash.com/photo-1604328698692-f76ea9498e76?w=800&q=80', alt: 'Conference room' },
  { src: 'https://images.unsplash.com/photo-1568992687947-868a62a9f521?w=800&q=80', alt: 'Reception area' },
  { src: 'https://images.unsplash.com/photo-1527192491265-7e15c55b1ed2?w=800&q=80', alt: 'Co-working space' },
];

const officeTypes = [
  { name: 'EXECUTIVE CABIN', img: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=600&q=80' },
  { name: 'OPEN WORKSPACE', img: 'https://images.unsplash.com/photo-1497215842964-222b430dc094?w=600&q=80' },
  { name: 'CONFERENCE ROOM', img: 'https://images.unsplash.com/photo-1604328698692-f76ea9498e76?w=600&q=80' },
  { name: 'RECEPTION', img: 'https://images.unsplash.com/photo-1568992687947-868a62a9f521?w=600&q=80' },
  { name: 'BREAK ROOM', img: 'https://images.unsplash.com/photo-1527192491265-7e15c55b1ed2?w=600&q=80' },
];

const features = [
  { icon: '🏢', title: 'Complete Office Fitout', desc: 'From bare shell to fully furnished — we design and execute complete office interior projects on time.' },
  { icon: '📐', title: 'Space Planning', desc: 'Optimized layouts for maximum productivity, collaboration, and employee comfort.' },
  { icon: '🎨', title: 'Brand Integration', desc: 'We weave your brand identity into every element — colors, materials, graphics, and signage.' },
  { icon: '💡', title: 'Smart Lighting', desc: 'Task-appropriate lighting systems that boost productivity and reduce energy costs.' },
  { icon: '🪑', title: 'Ergonomic Furniture', desc: 'Premium workstations, conference tables, and storage solutions built for comfort and durability.' },
  { icon: '🔧', title: 'Turnkey Delivery', desc: 'Electrical, plumbing, HVAC coordination, false ceiling, flooring — all managed under one roof.' },
];

const stats = [
  { title: '150+', sub: 'Offices Done' },
  { title: 'SINCE', sub: '2014' },
  { title: '100%', sub: 'Turnkey' },
            ...
            >
              <div className="w-full">
                <h2 className="font-['Mulish',sans-serif] font-normal uppercase text-black text-[22px] leading-[30px] min-[468px]:text-[28px] min-[468px]:leading-normal sm:text-[30px] xl:text-[28px] min-[1700px]:text-[32px] m-0 p-0 mb-4">
                  OFFICE <span className="text-[#814882] font-semibold">INTERIOR</span>
                </h2>
                <p className="m-0 text-[#4c4c4c] text-[15px] leading-[25px] sm:text-base sm:leading-[26px] mb-8">
                  Create an inspiring workplace with Woodland Furniture's premium office interior solutions. We design and deliver complete office fitouts — from executive cabins and conference rooms to open workspaces and reception areas. Our team handles everything: space planning, furniture, electrical, false ceiling, flooring, and branding — all with on-time delivery and zero hassle.
                </p>
            ...
            {officeTypes.map((type, idx) => (
              <div key={idx} className={idx === 0 ? 'w-full' : 'w-[calc(50%-3px)] sm:w-[calc(50%-6px)]'} style={fadeStyle('types', idx * 0.15)}>
                <Link to="/contact" className="block h-[155px] sm:h-[280px] md:h-[320px] min-[1681px]:h-[380px] relative overflow-hidden group bg-white">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-black text-white uppercase transition-colors duration-500 group-hover:text-[#814882] z-[1] text-[20px] min-[390px]:text-[24px] min-[468px]:text-[30px] sm:text-[36px] md:text-[44px] lg:text-[52px]" style={{ fontFamily: "'Mulish', sans-serif" }}>
                    {type.name}
                  </div>
                </Link>
              </div>
      ...
      <section className="py-[35px] sm:py-[50px] lg:py-[60px] bg-[#f8f8f8] overflow-hidden" data-anim="cta">
        <div className="w-full px-5 md:px-[60px] min-[1441px]:px-[100px] mx-auto text-center" style={fadeStyle('cta')}>
          <h2 className="font-normal uppercase text-black text-[22px] min-[468px]:text-[28px] sm:text-[30px] lg:text-[34px] min-[1390px]:text-[38px] mb-4" style={{ fontFamily: "'Mulish', sans-serif" }}>
            READY TO UPGRADE YOUR <span className="text-[#814882] font-semibold">WORKSPACE?</span>
          </h2>
          <p className="text-[#4c4c4c] text-[14px] sm:text-[15px] leading-[1.8] max-w-[600px] mx-auto mb-8">
            Book a free consultation with our office design team. We'll visit your site, understand your requirements, and deliver a stunning workspace.
          </p>
          <button onClick={() => setShowModal(true)} className="btn-comn hoveranim">
          ...
          <div className="bg-white/82 rounded-[5px] w-[90%] max-w-[500px] relative overflow-hidden">
            ...
            <div className="px-6 pb-10">
              <form onSubmit={(e) => { e.preventDefault(); setShowModal(false); }}>
                ...
                <div className="mb-3"><input type="text" placeholder="Office Location" className="w-full h-[50px] border border-[#707070] rounded-[5px] px-2.5 py-1 text-[13px] bg-white outline-none" /></div>
